      ...
      export function DailyChallenge({
        ...
        const targetReached = score >= DAILY_TARGET_SCORE;
              ...
              {loadingRound ? (
                ...
                <div className="results-sheet">
                  ...
                  {score < DAILY_TARGET_SCORE ? (
                    <>
                      <p>
                        You scored {score} points. You need {DAILY_TARGET_SCORE} points to claim today's reward. Try again tomorrow.
                      </p>
                      <div className="hero-actions">
                    ...
                    <>
                      ...
                      {dailyClaimTx ? (
                        <p>
                          TX:{" "}
                          <a href={`https://celoscan.io/tx/${dailyClaimTx}`} target="_blank" rel="noreferrer">
                    ...
                    <>
                      ...
                      {dailyClaimMessage ? <div className="notice-strip notice-strip--success">{dailyClaimMessage}</div> : null}
                      {dailyClaimError ? <div className="notice-strip notice-strip--error">{dailyClaimError}</div> : null}
                      <div className="hero-actions">
